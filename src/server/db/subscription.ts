import { subscriptionTiers } from '@/data/subscriptonTiers';
...
export async function getUserSubscriptionTier(userId: string) {
  ...
  if (subscription == null) {
    throw new Error(
      `User ${userId} has no subscription. Please ensure the user is subscribed before accessing subscription tiers.`
    );
  }
